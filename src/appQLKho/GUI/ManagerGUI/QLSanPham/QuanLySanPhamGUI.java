package appQLKho.GUI.ManagerGUI.QLSanPham;
...
public class QuanLySanPhamGUI extends JFrame {
    ...
    public QuanLySanPhamGUI() {
        ...
        filterPanel.setBorder(BorderFactory.createTitledBorder("Danh mục sản phẩm"));
...
//        button.setBackground(Color.WHITE);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new QuanLySanPhamGUI().setVisible(true));
    }
}
