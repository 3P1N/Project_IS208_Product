 ...
 * @author pc
 */
public class TraCuuNhanVien extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TraCuuNhanVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
