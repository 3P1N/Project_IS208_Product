...
public class NhanVienGUI extends JFrame {
    ...
    public NhanVienGUI(NguoiDung nguoiDung) throws SQLException, ClassNotFoundException, Exception {
        ...
        // Tạo menu
        NhanVienSidebar sidebar = new NhanVienSidebar(nguoiDung);
        ...
        contentPanel.add(new QuanLyNhapXuatPanel(nguoiDung), "Quản lý nhập xuất");
