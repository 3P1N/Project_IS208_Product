...
import appQLKho.GUI.ManagerGUI.*;

/**
 *
 * @author pc
 */
public class QuanLyBaoCao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Báo cáo tồn kho");
        ...
        jLabel1.setText("Quản lý báo cáo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyBaoCao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuanLyBaoCao().setVisible(true);
            }
        });
    }
