 ...
 * @author HP
 */
public class NhanVienSidebar extends Sidebar {

    private static final List<String> items = Arrays.asList("Quản lý nhập xuất", "Đăng xuất");
    private static final List<String> icons = Arrays.asList("customer.png", "logout.png");

    public NhanVienSidebar(NguoiDung nguoiDung) throws SQLException, ClassNotFoundException {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            NhanVienSidebar sidebar = null;

            NguoiDung nd = new NguoiDung();
            nd.setIdNguoiDung(1);
            try {
                nd = NguoiDungDAO.LayThongTinNguoiDung(nd);
                sidebar = new NhanVienSidebar(nd);
            } catch (SQLException ex) {
                Logger.getLogger(NhanVienSidebar.class.getName()).log(Level.SEVERE, null, ex);
