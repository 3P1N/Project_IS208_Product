package appQLKho.GUI.ManagerGUI.QLPhieuNhapXuat;
...
//        leftPanel.add(filterPanel);
        ...
        String[] columnNames = {"Mã Phiếu", "Loại Phiếu", "Trạng thái"};
...
//        button.setBackground(Color.WHITE);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new QLPhieuNhapXuatGUI().setVisible(true));
    }
}
