 ...
 */
package appQLKho.GUI.NhanVienNhapGUI;
...
public class TaoPhieuNhapHang extends JFrame {
    ...
    public TaoPhieuNhapHang() {
        ...
        pnlThongTin.setBorder(BorderFactory.createTitledBorder("Thông tin phiếu nhập"));
        ...
        btnTaoPhieu.addActionListener(e -> {
            if (txtNhaCungCap.getText().isEmpty() || txtNguoiNhap.getText().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Vui lòng điền đầy đủ thông tin phiếu nhập.", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
